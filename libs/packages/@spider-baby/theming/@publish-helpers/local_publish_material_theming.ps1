# --- Configuration for @spider-baby/material-theming package local publishing ---


$ErrorActionPreference = "Stop"

# Package details and paths
$packageName = "@spider-baby/material-theming"
$packageDistRelativePath = "dist\libs\packages\@spider-baby\theming"
$nxBuildTarget = "sb-material-theming:build:production"
