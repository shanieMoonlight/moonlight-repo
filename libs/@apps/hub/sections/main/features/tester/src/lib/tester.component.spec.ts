...
import {HubMainTesterComponent } from './tester.component';
...
describe('HubMainTesterComponent', () => {
  let component:HubMainTesterComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HubMainTesterComponent, RouterModule.forRoot([])],
      providers: [
        IconsService,
    ...
    const fixture = TestBed.createComponent(HubMainTesterComponent);
