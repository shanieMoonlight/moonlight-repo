...
import {HubBlogHashComponent } from './hash.component';
...
describe('HubBlogHashComponent', () => {
  let component:HubBlogHashComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HubBlogHashComponent, RouterModule.forRoot([])],
      providers: [
        IconsService,
    ...
    const fixture = TestBed.createComponent(HubBlogHashComponent);
