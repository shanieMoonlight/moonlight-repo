...
import {HubBlogFirebaseDeployComponent } from './firebase-deploy.component';
...
describe('HubBlogFirebaseDeployComponent', () => {
  let component:HubBlogFirebaseDeployComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HubBlogFirebaseDeployComponent, RouterModule.forRoot([])],
      providers: [
        IconsService,
    ...
    const fixture = TestBed.createComponent(HubBlogFirebaseDeployComponent);
