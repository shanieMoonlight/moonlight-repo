...
describe('HubBlogProgImgTutorialComponent', () => {
  let component:HubBlogProgImgTutorialComponent;
  ...
  beforeEach(async () => {
    ...
    const fixture = TestBed.createComponent(HubBlogProgImgTutorialComponent);
