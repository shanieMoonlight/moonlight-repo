...
import {HubBlogRouteDefsTutorialComponent } from './route-defs-tutorial.component';
...
describe('HubBlogRouteDefsTutorialComponent', () => {
  let component:HubBlogRouteDefsTutorialComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HubBlogRouteDefsTutorialComponent, RouterModule.forRoot([])],
      providers: [
        IconsService,
    ...
    const fixture = TestBed.createComponent(HubBlogRouteDefsTutorialComponent);
