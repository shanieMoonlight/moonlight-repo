...
import {HubBlogMatThemingComponent } from './mat-theming.component';
...
describe('HubBlogMatThemingComponent', () => {
  let component:HubBlogMatThemingComponent;
  ...
  beforeEach(async () => {
    ...
    const fixture = TestBed.createComponent(HubBlogMatThemingComponent);
