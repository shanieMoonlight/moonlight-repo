...
import {HubBlogMiniStateComponent } from './mini-state.component';
...
describe('HubBlogMiniStateComponent', () => {
  let component:HubBlogMiniStateComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HubBlogMiniStateComponent, RouterModule.forRoot([])],
      providers: [
        IconsService,
    ...
    const fixture = TestBed.createComponent(HubBlogMiniStateComponent);
