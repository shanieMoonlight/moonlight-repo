...
import {HubBlogPortalComponent } from './portal.component';
...
describe('HubBlogPortalComponent', () => {
  let component:HubBlogPortalComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HubBlogPortalComponent, RouterModule.forRoot([])],
      providers: [
        IconsService,
    ...
    const fixture = TestBed.createComponent(HubBlogPortalComponent);
