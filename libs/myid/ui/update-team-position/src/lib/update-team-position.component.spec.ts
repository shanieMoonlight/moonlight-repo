...
describe('SbUpdateTeamPositionFormComponent', () => {
  ...
  it('should set form values with input data', () => {
    ...
    expect(component['_form'].controls.newPosition.value).toBe(
      inputData.teamPosition
    );
  });
  ...
  it('should render User Info', () => {
    ...
    console.log(
      'userElement.nativeElement.textContent',
      userElement.nativeElement.textContent
    );
    ...
    expect(userElementNoUsername.nativeElement.textContent).toContain(
      inputDataNoUsername.email
    );
  });
