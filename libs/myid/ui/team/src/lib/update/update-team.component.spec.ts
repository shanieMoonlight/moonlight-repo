...
describe('SbUpdateTeamFormComponent', () => {
  ...
  it('should render READONLY team-position when canChangeTeamPositionRange is false ', () => {
    ...
    console.log(
      'canChangeTeamPositionRange',
      component['canChangeTeamPositionRange']()
    );
    fixture.detectChanges();
    const minInput = fixture.debugElement.query(
      By.css('.team-position #minPosition')
    );
    const maxInput = fixture.debugElement.query(
      By.css('.team-position #maxPosition')
    );

    console.log(
      'minInput.nativeElement.readonly',
      minInput.nativeElement.readonly
    );
  ...
  it('should render team-position when canChangeTeamPositionRange is true ', () => {
    ...
    const teamPositionSection = fixture.debugElement.query(
      By.css('.team-position')
    );
    fixture.detectChanges();
