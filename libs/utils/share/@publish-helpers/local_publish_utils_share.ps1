# --- Configuration for @spider-baby/utils-share package local publishing ---


$ErrorActionPreference = "Stop"

# Package details and paths
$packageName = "@spider-baby/utils-share"
$packageDistRelativePath = "dist\libs\utils\share"
$nxBuildTarget = "sb-utils-share:build:production"
