# --- Configuration for @spider-baby/utils-open-in-new-window package local publishing ---


$ErrorActionPreference = "Stop"

# Package details and paths
$packageName = "@spider-baby/utils-open-in-new-window"
$packageDistRelativePath = "dist\libs\utils\oinw"
$nxBuildTarget = "sb-utils-open-in-new-window:build:production"
