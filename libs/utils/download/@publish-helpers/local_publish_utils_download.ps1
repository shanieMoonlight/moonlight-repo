# --- Configuration for @spider-baby/utils-download package local publishing ---


$ErrorActionPreference = "Stop"

# Package details and paths
$packageName = "@spider-baby/utils-download"
$packageDistRelativePath = "dist\libs\utils\download"
$nxBuildTarget = "sb-utils-download:build:production"
