# --- Configuration for @spider-baby/utils-memoization package local publishing ---
...
$publisherScriptRelativePath = "scripts-ps1/shared/npm/local-npm-publish-package.ps1"
