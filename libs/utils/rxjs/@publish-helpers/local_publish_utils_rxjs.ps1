# --- Configuration for @spider-baby/utils-rxjs package local publishing ---


$ErrorActionPreference = "Stop"

# Package details and paths
$packageName = "@spider-baby/utils-rxjs"
$packageDistRelativePath = "dist\libs\utils\rxjs"
$nxBuildTarget = "sb-utils-rxjs:build:production"
