# --- Configuration for @spider-baby/utils-seo package local publishing ---


$ErrorActionPreference = "Stop"

# Package details and paths
$packageName = "@spider-baby/utils-seo"
$packageDistRelativePath = "dist\libs\utils\seo"
$nxBuildTarget = "spider-baby-utils-seo:build:production"
