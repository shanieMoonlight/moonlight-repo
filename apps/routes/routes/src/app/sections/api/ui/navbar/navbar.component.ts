...
@Component({
  selector: 'rd-admin-navbar',
  standalone: true,
  imports: [MatEverythingModule, NgTemplateOutlet, RouterModule],
...
export class AdminNavbarComponent {
  ...
  _lhsOutletTemplate = input<TemplateRef<any> | undefined>(undefined, {
    alias: 'lhsOutletTemplate',
  });
