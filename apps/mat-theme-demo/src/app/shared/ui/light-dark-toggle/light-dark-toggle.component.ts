...
@Component({
    ...
    <mat-slide-toggle 
      ...
      <span class="icon-track">
        ...
        <svg class="icon sun" viewBox="0 0 24 24">
          <path [attr.d]="_sunPath()" />
        </svg>
      }@else {
        <svg class="icon moon" viewBox="0 0 24 24">
          <path [attr.d]="_moonPath()" />
        </svg>
        }
      </span>
  ...
  styles: `
    ...
    ::ng-deep ml-light-dark-toggle .mdc-switch__icon {
...
export class LightDarkToggleComponent {
  ...
  _sunPath = input(DEFAULT_SUN_PATH, { alias: 'sunPath' });
  _moonPath = input(DEFAULT_MOON_PATH, { alias: 'moonPath' });
