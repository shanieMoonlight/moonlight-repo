...
import { SbVerify2FactorFormComponent, Verify2FactorTknFormDto } from '@spider-baby/myid-ui-forms/verify-2factor';
...
@Component({
  ...
  providers: [Verify2FactorCookieStateService],
  templateUrl: './verify-2-factor-cki.component.html',
  styleUrl: './verify-2-factor-cki.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Verify2FactorCookieComponent {
  
  private _state = inject(Verify2FactorCookieStateService)
